...
type CollaborativeProcess interface{ Create() CProcess }
...
func NewCollaborativeProcess() CollaborativeProcess {
	cp := Builder.Inject(CProcess{}).(CProcess)
	cp.Def = core.NewDefinitions()
	return &cp
}
...
// collaboration ...
func (cp CProcess) collaboration() *collaboration.Collaboration { return cp.Def.GetCollaboration() }

// customerSupportProces ...
func (cp CProcess) customerSupportProcess() *process.Process { return cp.Def.GetProcess(0) }

// customerProcess ...
func (cp CProcess) customerProcess() *process.Process { return cp.Def.GetProcess(1) }

// diagram ...
func (cp CProcess) diagram() *canvas.Diagram { return cp.Def.GetDiagram(0) }

// plane ...
func (cp CProcess) plane() *canvas.Plane { return cp.diagram().GetPlane() }
