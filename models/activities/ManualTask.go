...
func (manualTask *ManualTask) SetExtensionElements() {
	manualTask.ExtensionElements = make([]camunda.ExtensionElements, 1)
}
...
// GetID ...
func (manualTask *ManualTask) GetID() *string {
	return &manualTask.ID
}

// GetName ...
func (manualTask *ManualTask) GetName() *string {
...
func (manualTask ManualTask) GetExtensionElements() *camunda.ExtensionElements {
