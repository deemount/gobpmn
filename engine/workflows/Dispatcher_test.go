...
// /opt/homebrew/opt/go/libexec/bin/go test -v -timeout 30s -run ^TestRegister$ github.com/deemount/gobpmn/models/bpmn/events
...
// /opt/homebrew/opt/go/libexec/bin/go test -v -timeout 30s -run ^TestDispatch$ github.com/deemount/gobpmn/models/bpmn/events
